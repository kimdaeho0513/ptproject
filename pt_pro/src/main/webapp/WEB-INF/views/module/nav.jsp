...
<body id="page-top">
	...
	<nav class="navbar navbar-expand-lg navbar-dark fixed-top" id="mainNav">
		<div class="container">
			<a class="navbar-brand" href="#page-top" onclick="location.href='/pt'">KH fitness</a>
				...
				<ul class="navbar-nav text-uppercase ms-auto py-4 py-lg-0">
					...
					<c:if test="${not empty sessionScope.loginData}">
						<c:if test="${sessionScope.loginData.roles eq 'M'}">
							<li class="nav-item"><a class="nav-link" href="/pt/schedule">pt 예약조회</a></li>
						</c:if>
						<c:if test="${sessionScope.loginData.roles eq 'T'}">
							<li class="nav-item"><a class="nav-link" href="/pt/trschedule">회원 pt조회</a></li>
						</c:if>
						<c:if test="${not empty sessionScope.loginData}">
